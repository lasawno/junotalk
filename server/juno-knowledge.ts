...
const GENERAL_KNOWLEDGE: KnowledgeEntry[] = [
  ...
  { q: "What is The Well dataset?", a: "The Well is a large-scale open collection of 15TB of physics simulations, released by Polymathic AI at NeurIPS 2024 (arXiv: 2412.00568). It contains numerical simulations of spatiotemporal physical systems across 16 datasets, built in collaboration with domain scientists and numerical software developers. It is available on Hugging Face (polymathic-ai), installable via pip (pip install the-well, v1.2.0), and licensed under BSD-3-Clause. Individual datasets range from 6.9GB to 5.1TB in HDF5 format. Data can be accessed via PyTorch DataLoader or streamed directly from the Hugging Face Hub.", category: "science", tags: ["physics", "dataset", "machine learning", "simulations", "the well", "NeurIPS", "PolymathicAI"] },
  { q: "What are the 16 datasets in The Well?", a: "The Well contains these 16 physics simulation datasets: (1) active_matter — active rod-like particles in a Stokes fluid (biological/fluid); (2) acoustic_scattering_discontinuous — acoustic waves through discontinuous media; (3) acoustic_scattering_inclusions — acoustic waves through inclusion-based media; (4) acoustic_scattering_maze — acoustic waves through maze-like variable-density substrata; (5) convective_envelope_rsg — convective envelope of red supergiant stars (astrophysics); (6) euler_multi_quadrants — compressible inviscid gas with multiple shock interactions (fluid dynamics); (7) gray_scott_reaction_diffusion — Gray-Scott reaction-diffusion self-assembly (chemistry/biology); (8) helmholtz_staircase — Helmholtz wave scattering for inverse problems (acoustics); (9) MHD_64 — isothermal magnetohydrodynamic turbulence at 64³ resolution (astrophysics); (10) MHD_256 — same MHD turbulence at full 256³ resolution; (11) planetswe — shallow water equations on a sphere initialized from ERA5 reanalysis (geophysics/atmosphere); (12) post_neutron_star_merger — GR-MHD dynamics of hot dense remnant after neutron star merger; (13) rayleigh_benard — thermally driven Rayleigh-Bénard convection (fluid dynamics); (14) rayleigh_taylor_instability — interfacial instability between fluids of different densities; (15) supernova_explosion_64 and supernova_explosion_128 — core-collapse supernova MHD shock dynamics at 64³ and 128³; (16) turbulent_radiative_layer_2D/3D — turbulent cooling and radiative layers in the interstellar medium.", category: "science", tags: ["the well", "dataset", "physics", "all datasets", "MHD", "fluid dynamics", "acoustics", "astrophysics", "NeurIPS", "PolymathicAI"] },
  { q: "What physics domains does The Well cover?", a: "The Well spans six major physics domains across its 16 datasets: (1) Biological/active matter systems; (2) Acoustic wave scattering including discontinuous media, inclusions, mazes, and Helmholtz problems; (3) Astrophysics including magnetohydrodynamic turbulence (MHD_64, MHD_256), red supergiant convective envelopes, post-neutron-star-merger GR-MHD, and supernova explosions; (4) Fluid dynamics including Euler multi-quadrant Riemann problems, Rayleigh-Bénard convection, Rayleigh-Taylor instability, and shear flow; (5) Geophysics/atmosphere via shallow water equations on a sphere (planetswe); (6) Chemistry/biology via Gray-Scott reaction-diffusion and turbulent radiative layers in the interstellar medium.", category: "science", tags: ["physics", "fluid dynamics", "acoustics", "astrophysics", "MHD", "the well", "dataset"] },
  { q: "How big is The Well physics dataset?", a: "The Well totals 15 terabytes (15TB), with individual datasets ranging from 6.9GB to 5.1TB each. Data is stored in HDF5 (.h5) format as float32 arrays split 80/10/10 for train/validation/test. It is hosted on Hugging Face (polymathic-ai) and can be downloaded via the-well-download CLI or streamed from the Hub. The paper was published at NeurIPS 2024 (arXiv: 2412.00568). GitHub: github.com/PolymathicAI/the_well.", category: "science", tags: ["the well", "dataset", "15TB", "physics", "NeurIPS", "hugging face", "HDF5"] },
